...
bool SkpMallocPoolEx::free(const char *file, uint16 line, const char *function, void *p)
{
    ...
    skp_pool_large_ex_t *largeNode = (skp_pool_large_ex_t *)((uint)p - SKP_ALIGN_LARGE_HEAD_EX);
    ...
    skp_pool_align_head_t *node = (skp_pool_align_head_t *)((uint)p - SKP_ALIGN_HEAD_EX);
